...
function CheckInView() {
  ...
  const altitudeOptions = ['10K Tandem', '14K Tandem', '17K Tandem', 'AFF', 'Hop & Pop'];
  const mediaOptions = ['None', 'Video', 'Photos', 'Both', 'Undecided'];
    ...
    <div className="flex flex-col bg-bg text-fg">
      ...
      <div className="flex">
        <div className="w-2/3 p-6 space-y-6">
          ...
          {jumpers.filter(j => j.name?.toLowerCase().includes(search.toLowerCase())).map((student, i) => (
